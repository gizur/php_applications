...
class ApiController extends Controller {
    ...
    public function beforeAction($action) {
        ...
        try {
            ...
            Yii::log(
                    ...
                    json_encode($_SERVER) .
                    " GET VAR " . json_encode($_GET), CLogger::LEVEL_TRACE
            );
            ...
            if (!isset($_SERVER['HTTP_X_CLIENTID'])) {
                ...
                Yii::log(
                        ...
                        "resource  intensive validation)", CLogger::LEVEL_TRACE
                );
                ...
                if ($GIZURCLOUD_SECRET_KEY === false) {
                    ...
                    Yii::log(
                            " TRACE(" . $this->_traceId . "); " .
                            " FUNCTION(" . __FUNCTION__ . "); " .
                            " VALIDATION (Scan API KEY 1)", CLogger::LEVEL_TRACE
                    );
                    ...
                    if ($publicKeyNotFound = ($ddbResponse->body->Count == 0)) {
                        ...
                        Yii::log(
                                " TRACE(" . $this->_traceId . "); " .
                                " FUNCTION(" . __FUNCTION__ . "); " .
                                " VALIDATION (Scan API KEY 2)", CLogger::LEVEL_TRACE
                        );
                    ...
                    Yii::log(
                            ...
                            (string) $ddbResponse->body->Items->clientid->{AmazonDynamoDB::TYPE_STRING}, CLogger::LEVEL_TRACE
                    );
                    ...
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'], $GIZURCLOUD_SECRET_KEY
                    );
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_clientid", $this->_clientid
                    );

                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_dbpassword", $this->_dbpassword
                    );
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_dbhost", $this->_dbhost
                    );
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_dbuser", $this->_dbuser
                    );
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_dbname", $this->_dbname
                    );
                    Yii::app()->cache->set(
                            $_SERVER['HTTP_X_GIZURCLOUD_API_KEY'] . "_contactinfo", $this->_contactinfo
                    );
                } else {
                ...
                Yii::log(
                        " TRACE(" . $this->_traceId . "); " .
                        " FUNCTION(" . __FUNCTION__ . "); " .
                        " VALIDATION (Generating Signature)", CLogger::LEVEL_TRACE
                );
                ...
                Yii::log(
                        ...
                        "    SIGNATURE RECEIVED:" . $_SERVER['HTTP_X_SIGNATURE'], CLogger::LEVEL_TRACE
                );
                ...
                if ($who = Yii::app()->cache->get($_SERVER['HTTP_X_SIGNATURE']) !== false) {
                    ...
                    Yii::log(
                            " TRACE(" . $this->_traceId . "); " .
                            " FUNCTION(" . __FUNCTION__ . "); " .
                            "    WHO USED THE SIGNATURE:" . $who, CLogger::LEVEL_TRACE
                    );
                ...
                Yii::app()->cache->set(
                        $_SERVER['HTTP_X_SIGNATURE'], json_encode(
                                array(
                                    "trace" => $this->_traceId,
                ...
                Yii::log(
                        " TRACE(" . $this->_traceId . "); " .
                        " FUNCTION(" . __FUNCTION__ . "); " .
                        " VALIDATION (IN PRIVATE VAR) " . $this->_clientid, CLogger::LEVEL_TRACE
                );
                ...
                if (($this->_dbuser = Yii::app()->cache->get($_SERVER['HTTP_X_CLIENTID'] . "_dbuser")) === false) {
                    ...
                    Yii::log(
                            " TRACE(" . $this->_traceId . "); " .
                            " FUNCTION(" . __FUNCTION__ . "); " .
                            " VALIDATION (Scan Client ID)", CLogger::LEVEL_TRACE
                    );
                    ...
                    if ($ddbResponse->body->Count != 0) {
                        ...
                        //avoid repeated calls to Dynamo DB
                        Yii::app()->cache->set(
                                $_SERVER['HTTP_X_CLIENTID'] . "_dbpassword", $this->_dbpassword
                        );
                        Yii::app()->cache->set(
                                $_SERVER['HTTP_X_CLIENTID'] . "_dbhost", $this->_dbhost
                        );
                        Yii::app()->cache->set(
                                $_SERVER['HTTP_X_CLIENTID'] . "_dbuser", $this->_dbuser
                        );
                        Yii::app()->cache->set(
                                $_SERVER['HTTP_X_CLIENTID'] . "_dbname", $this->_dbname
                        );
                        Yii::app()->cache->set(
                                $_SERVER['HTTP_X_CLIENTID'] . "_contactinfo", $this->_contactinfo
                        );
                    } else {
                        throw new Exception(
                        'Client ID not found'
            ...
            Yii::log(
                    ...
                    " or using preused session)", CLogger::LEVEL_TRACE
            );
            ...
            if ($cacheValue === false) {
                ...
                $rest = new RESTClient();
                $rest->format('json');
                $account = $rest->get($this->_vtresturl . "?$params");
                ...
                $response->result->account_no = $account['result'][0]['account_no'];
            ...
            Yii::log(
                    " TRACE(" . $this->_traceId . "); " .
                    " FUNCTION(" . __FUNCTION__ . "); " .
                    " VALIDATION (Storing session)", CLogger::LEVEL_TRACE
            );
            ...
            Yii::log(
                    ...
                    " ERROR ( " . $e->getMessage() . ") ", CLogger::LEVEL_TRACE
            );
            ...
            if ($_GET['model'] != 'About') {
                ...
                if ($e->getCode() == 1003) {
                    if (isset($_SERVER['HTTP_X_TIMESTAMP'])) {
                        ...
                        $response->error->time_difference = $_SERVER['REQUEST_TIME'] - $reqTime;
                    }
                ...
                if ($e->getCode() == 1005) {
                    ...
                    $this->_sendResponse(
                            ...
                            '</a> ' .
                            'in order to setup an account.', 'text/html'
                    );
                }
            }
    ...
    public function actionList() {
        ...
        Yii::log(
                " TRACE(" . $this->_traceId . "); " .
                " FUNCTION(" . __FUNCTION__ . "); " .
                " PROCESSING REQUEST (" . json_encode($_GET) . ")", CLogger::LEVEL_TRACE
        );
                ...
                case 'HelpDesk':
                            ...
                            foreach ($response['result']['fields'] as $field) {
                                ...
                                if ($field['type']['name'] == 'picklist') {
                                    ...
                                    //for the picklist value
                                        if (isset($option['dependency'])) {
                                            ...
                                            as $depFieldname => $dependency) {
                                                if (in_array(
                                                                $depFieldname, Yii::app()->params[$this->_clientid .
                                    ...
                                    Yii::app()->cache->set(
                                            ...
                                            . $_GET['model']
                                            . '_'
                                            . $flippedCustomFields[$field['name']], $content
                                    );
                    ...
                    if (isset($_GET['category'])) {
                        ...
                        if (isset($_GET['ticketstatus'])) {
                             ...
                             $ticketstatus = " AND ticketstatus = '$ticketst'";
                        } else {
                            $ticketstatus = ' ';
                        }
                         $query = $query . " $ticketstatus order by id desc limit $minLimit, $maxLimit;";
...
// END FETCHING DOCUMENT
 //Before sending response santise custom fields names to 
                ...
                case 'Background':
                    ...
                    if (isset($_GET['action']) &&
                        ...
                        Yii::log(
                                ...
                                " STATUS FROM DYNAMODB FOR $email", CLogger::LEVEL_TRACE
                        );
    ...
    public function actionView() {
        ...
        try {
            ...
            Yii::log(
                    "TRACE(" . $this->_traceId .
                    "); FUNCTION(" . __FUNCTION__ .
                    "); PROCESSING REQUEST ", CLogger::LEVEL_TRACE
            );
            ...
            switch ($_GET['model']) {
                ...
                case 'Images':
                    ...
                    $sThreeResponse = $sThree->get_object(
                            Yii::app()->params->awsS3Bucket, $imageName, array(
                ...
                case 'HelpDesk':
                    ...
                    Yii::log(
                            ...
                            json_encode($_GET), CLogger::LEVEL_TRACE
                    );
                ...
                case 'User':
                    ...
                    if ($_GET['action'] == 'copyuser') {
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " CREATING MDB OBJECT ", CLogger::LEVEL_TRACE
                        );
                        ...
                        Yii::log(
                                ...
                                $dbconfig['db_server'], CLogger::LEVEL_TRACE
                        );
                        $mysqli = new mysqli(
                                $dbconfig['db_server'] . $dbconfig['db_port'], $dbconfig['db_username'], $dbconfig['db_password'], $dbconfig['db_name']
                        );
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " CREATING AmazonDynamoDB CONNNECTION ", CLogger::LEVEL_TRACE
                        );
                        // Instantiate the class
                        $dynamodb = new AmazonDynamoDB();
                        $dynamodb->set_region(
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " GET POST VALUES ", CLogger::LEVEL_TRACE
                        );
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " RECEIVED POST : " . json_encode($post), CLogger::LEVEL_TRACE
                        );
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " VALIDATE NEW CLIENT ID " . $post['clientid'], CLogger::LEVEL_TRACE
                        );
                        //Validate Client ID
                        $ddbResponse = $dynamodb->scan(
                                array(
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " VALIDATE NEW CLIENT EMAIL " . $post['id'], CLogger::LEVEL_TRACE
                        );
                        // Validate Email
                        $ddbResponse = $dynamodb->get_item(
                                array(
                        ...
                        Yii::log(
                                ...
                                " so processing further. ", CLogger::LEVEL_TRACE
                        );

                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " GETING ID_SEQUENCE FROM DYNAMODB. ", CLogger::LEVEL_TRACE
                        );
                        $ddbResponse = $dynamodb->scan(
                                array(
                                    'TableName' => Yii::app()->params->awsDynamoDBTableName,
                        ...
                        foreach ($ddbResponse->body->Items
                        as $key => $item) {
                            $idSequence = intval((string) $item->id_sequence->{AmazonDynamoDB::TYPE_STRING});
                        ...
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " NEW ID_SEQUENCE FOR THE CLIENT IS $maxIdSequence.", CLogger::LEVEL_TRACE
                        );
                        Yii::log(
                                "TRACE(" . $this->_traceId . ");" .
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " GET FROM CLIENT (WHICH IS BEING COPIED " .
                                "TO NEW) DETAILS. ", CLogger::LEVEL_TRACE
                        );
                        ...
                        Yii::log(
                                ...
                                " DETAILS FETCHED FROM DYNAMODB. ", CLogger::LEVEL_TRACE
                        );
                        ...
                        Yii::log(
                                ...
                                " FUNCTION(" . __FUNCTION__ . ");" .
                                " FROM CLIENT (WHICH IS BEING COPIED TO NEW)" .
                                " DETAILS : " . json_encode($clientArr), CLogger::LEVEL_TRACE
                        );
                    ...
                    // Instantiate the class                   
                        ...
                        try {
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " NEW CLIENT DETAILS : " . json_encode($post), CLogger::LEVEL_TRACE
                            );

                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " CREATING USER ($dbUsername) IN MYSQL FOR NEW CLIENT ", CLogger::LEVEL_TRACE
                            );
                            ...
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " CREATING DATABASE ($dbName) IN MYSQL FOR NEW CLIENT ", CLogger::LEVEL_TRACE
                            );
                            //Create Database
                            //===============
                            ...
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " GRANTING PRIVILEGES ON $dbName TO $dbUsername ", CLogger::LEVEL_TRACE
                            );
                            //Grant Permission
                            //================
                            ...
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " IMPORTING DATABASE DUMP TO $dbName ", CLogger::LEVEL_TRACE
                            );
                            //Import Database
                            //===============
                            ...
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " UPDATING $dbName USERS IDs with $maxIdSequence ", CLogger::LEVEL_TRACE
                            );
                            ...
                            Yii::log(
                                    "TRACE(" . $this->_traceId . ");" .
                                    " FUNCTION(" . __FUNCTION__ . ");" .
                                    " INSERTING INTO DYNAMODB ", CLogger::LEVEL_TRACE
                            );
                            ...
                            if ($ddbResponse->isOK()) {
                                ...
                                Yii::log(
                                        "TRACE(" . $this->_traceId . ");" .
                                        " FUNCTION(" . __FUNCTION__ . ");" .
                                        " ACCOUNT CREATED : " . json_encode($post), CLogger::LEVEL_TRACE
                                );
                            } else {
    ...
    public function actionError() {
        ...
        Yii::log(
                "TRACE(" . $this->_traceId . "); FUNCTION(" .
                __FUNCTION__ . "); ERROR IN REQUEST ", CLogger::LEVEL_TRACE
        );
            ...
            switch ($_GET['model']) {
                ...
                case 'Authenticate':
                    if ($_GET['action'] == 'reset') {
                        ...
                        Yii::log(
                                " TRACE(" . $this->_traceId . "); " .
                                " FUNCTION(" . __FUNCTION__ . "); " .
                                " DELETED KEYS (" . json_encode($res) . ")", CLogger::LEVEL_TRACE
                        );
                ...
                case 'User':
                    if (isset($_GET['field'])) {
                        ...
                        Yii::app()->cache->set(
                                $result['apikey_' . $keyid], $result['secretkey_' . $keyid]
                        );
                ...
                case 'DocumentAttachment' :
                    ...
                    Yii::log(
                            " TRACE(" . $this->_traceId . "); " .
                            " FUNCTION(" . __FUNCTION__ . "); " .
                            " In DocumentAttachment ", CLogger::LEVEL_TRACE
                    );
                    //Continue to run script even when the connection is over
                    ignore_user_abort(true);
                    set_time_limit(0);
                    ...
                    foreach ($_FILES as $key => $file) {
                        ...
                        Yii::log(
                                " TRACE(" . $this->_traceId . "); " .
                                " FUNCTION(" . __FUNCTION__ . "); " .
                                " SAVING FILE " . $file['name'] . " TO S3", CLogger::LEVEL_TRACE
                        );
                    ...
                    Yii::log(
                            " TRACE(" . $this->_traceId . "); " .
                            " FUNCTION(" . __FUNCTION__ . "); " .
                            " UPDATING DYNAMODB : " . json_encode($dynDB), CLogger::LEVEL_TRACE
                    );
                    //Save result to DynamoDB
                    $dynamodb = new AmazonDynamoDB();
                    $dynamodb->set_region(
