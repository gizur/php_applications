...
if (isset($_GET['action'])) {
    ...
    switch ($_GET['action']) {
        case 'setup-tables':            
            $output = shell_exec('sudo ' . __DIR__ . '/setup-tables.sh');
            break;
        case 'phpcronjob1':
            $output = shell_exec('sudo ' . __DIR__ . '/phpcronjob1.sh');
            break;
        case 'phpcronjob2':
            $output = shell_exec('sudo ' . __DIR__ . '/phpcronjob2.sh');
            break;
        case 'phpcronjob3':
            $output = shell_exec('sudo ' . __DIR__ . '/phpcronjob3.sh');
            break;
        case 'phpcronjobs':
            /*
             * Cron Job 1
