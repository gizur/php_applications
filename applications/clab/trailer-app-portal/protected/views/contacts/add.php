...
<div id="content">
    <div id="createcontact">
        <div style="padding:20px" >
            ...
            <span class="lvtHeaderText"><strong>Creating New Contact</strong></span> <br>
                                                    ...
                                                    <tr valign="top">
                                                        <td style="padding:5px" colspan="4">
                                                            <div align="center">
                                                                ...
                                                                <input type="button" style="width:70px" value="  Cancel  " name="cancel" onclick="window.history.back()">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
