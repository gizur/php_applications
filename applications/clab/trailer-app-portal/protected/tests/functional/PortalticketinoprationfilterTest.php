...
class PortalticketinoprationfilterTest extends PHPUnit_Framework_TestCase
{
   ...
   public function testPortalticketinoprationfilter(){
        $model = 'HelpDesk';
        ...
        echo " Getting Ticket Inoperation Filter" . PHP_EOL;        
