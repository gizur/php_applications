...
if (isset($response->body->Item)) {
    ...
    $tab_info_array = eval(json_decode( (String) $items->tab_info_array->{AmazonDynamoDB::TYPE_STRING}, true));
    $tab_seq_array = eval(json_decode( (String) $items->tab_seq_array->{AmazonDynamoDB::TYPE_STRING}, true));
    $tab_ownedby_array = eval(json_decode( (String) $items->tab_ownedby_array->{AmazonDynamoDB::TYPE_STRING}, true));
    $action_id_array = eval(json_decode( (String) $items->action_id_array->{AmazonDynamoDB::TYPE_STRING}, true));
    $action_name_array = eval(json_decode( (String) $items->action_name_array->{AmazonDynamoDB::TYPE_STRING}, true));
} else {
